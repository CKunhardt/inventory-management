...
class Task(BaseModel):
    # String ids on purpose: the client merges these with per-user mock tasks
    # that use integer ids (1..4), and distinguishes the two by id equality.
    id: str
    title: str
    priority: str
    dueDate: str
...
def get_tasks():
    """Get all tasks created through the API"""
    return tasks
